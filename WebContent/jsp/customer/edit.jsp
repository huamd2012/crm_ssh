		...
		$
				.post(
						...
						function(data) {
							...
							// 使用EL获取值栈的数据
							$(
									"#cust_source option[value='${model.baseDictSource.dict_id}']")
		...
		$
				.post(
						...
						function(data) {
							...
							// 使用EL获取值栈的数据
							$(
									"#cust_level option[value='${model.baseDictLevel.dict_id}']")
									.prop("selected", "selected");
						}, "json");
		$
				.post(
						...
						function(data) {
							...
							// 使用EL获取值栈的数据
							$(
									"#cust_industry option[value='${model.baseDictIndustry.dict_id}']")
									.prop("selected", "selected");
						}, "json");
	});
</script>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							...
							<TR>
								<td>客户名称：</td>
								<td><s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" maxLength="50" name="cust_name"
							...
							<TR>
								...
								<td>固定电话 ：</td>
								<td><s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" maxLength="50" name="cust_phone"
										value="%{model.cust_phone}" /></td>
								<td>移动电话 ：</td>
								<td><s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" maxLength="50" name="cust_mobile"
