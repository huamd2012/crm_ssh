...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/linkMan_findAll.action"
		method=post>
									...
									<TD height=25>
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD><s:textfield theme="simple" name="lkm_name" cssClass="textbox" cssStyle="WIDTH: 80px"
															maxLength="50" /></TD>
													<TD>联系人性别：</TD>
													<TD><s:select theme="simple" name="lkm_gender" list="#{'1':'男','2':'女'}" headerKey=""
