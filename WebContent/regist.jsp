												...
												<TABLE cellSpacing=0 cellPadding=2 border=0>
													<TBODY>
														...
														<TR>
															...
															<TD style="HEIGHT: 28px" width=150><INPUT id=txtName style="WIDTH: 130px" name="user_name"></TD>
															<TD style="HEIGHT: 28px" width=370><SPAN id=RequiredFieldValidator3
																style="FONT-WEIGHT: bold; VISIBILITY: hidden; COLOR: white">请输入登录名</SPAN></TD>
														</TR>
														...
														<TR>
															...
															<TD><INPUT id=btn
																	...
																	type=image src="${ pageContext.request.contextPath }/images/regist_button.gif" name=btn></TD>
														</TR>
													</TBODY>
												</TABLE>
											</TD>
